    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl id="interaction_history" mb="4" isInvalid={!!formik.errors?.interaction_history}>
            <FormLabel>Interaction History</FormLabel>
            <Input
              type="text"
              name="interaction_history"
              value={formik.values?.interaction_history}
              onChange={formik.handleChange}
            />
            {formik.errors.interaction_history && (
              <FormErrorMessage>{formik.errors?.interaction_history}</FormErrorMessage>
            )}
          </FormControl>
